...
class Barbearia:
    def __init__(self, root):
        ...
        # Widgets
        self.lbl_dia_semana = tk.Label(root, text="Dia da Semana:", background="white")
        ...
        self.cmb_dia_semana.configure(font='Arial 14 italic', background="white")
        
        

        self.lbl_horario = tk.Label(root, text="Horário:")
        self.lbl_horario.grid(row=1, column=0, padx=5, pady=5)
        self.lbl_horario.configure(font='Arial 14 italic', background="white")
        ...
        self.cmb_horario.configure(font='Arial 14 italic', background="white")

        self.lbl_nome_cliente = tk.Label(root, text="Nome do Cliente:", background="white")
        ...
        self.entry_nome_cliente.configure(background="white")

        self.btn_agendar = tk.Button(root, text="Agendar",font="Arial 14 italic",background="white", command=self.agendar)
        self.btn_agendar.grid(row=3, columnspan=2, padx=5, pady=5)

        self.btn_ver_agendamentos = tk.Button(root, text="Ver Agendamentos",font="Arial 14 italic",background="white", command=self.ver_agendamentos)
        self.btn_ver_agendamentos.grid(row=4, columnspan=2, padx=5, pady=5)

        self.btn_deletar_agendamentos = tk.Button(root, text="Deletar Todos os Agendamentos",font="Arial 14 italic",background="white", command=self.deletar_agendamentos)
